...
SCHEMA_PATH="${ROOT_DIR}/planningops/schemas/monday-agent-harness-projection-status-bundle-status-bundle-status-bundle-status-bundle-status-bundle-validation.schema.json"
INVALID_BUNDLE="${TMP_DIR}/invalid-status-bundle-status-bundle-status-bundle-status-bundle-status-bundle.json"
INVALID_BUNDLE_VALIDATION="${TMP_DIR}/invalid-status-bundle-status-bundle-status-bundle-status-bundle-status-bundle-validation.json"
...
python3 "${ROOT_DIR}/planningops/scripts/resolve_monday_agent_harness_projection_status_bundle_status_bundle_status_bundle_status_bundle_status.py" \
  --artifact-file "${OUTER_STATUS}" \
  --output "${NEXT_BUNDLE}" >/dev/null

python3 "${ROOT_DIR}/planningops/scripts/validate_monday_agent_harness_projection_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle.py" \
...
assert report["status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path"] == str(bundle_path.resolve()), report
assert report["bundle_status_bundle_status_bundle_status_bundle_status_path"] == str(status_path.resolve()), report
assert report["bundle_status_bundle_status_bundle_status_bundle_validation_path"] == str(status_validation_path.resolve()), report
...
assert report["resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path"] == str(bundle_path.resolve()), report
PY
...
doc["bundle_status_bundle_status_bundle_status_bundle_report"]["bundle_status_bundle_status_bundle_status_bundle_validation_output_path"] = str(
...
assert any("resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path must match the validated bundle file path" in item for item in report["errors"]), report
assert any("ready must match bundle_status_bundle_status_bundle_status_bundle_report.ready" in item for item in report["errors"]), report
assert any("next_step must match bundle_status_bundle_status_bundle_status_bundle_report.next_step" in item for item in report["errors"]), report
assert any("bundle_status_bundle_status_bundle_status_bundle_report.bundle_status_bundle_status_bundle_status_bundle_validation_output_path must match bundle_status_bundle_status_bundle_status_bundle_validation_path" in item for item in report["errors"]), report
assert any("bundle must match canonical monday harness projection status-bundle-status-bundle-status-bundle-status-bundle-status bundle resolution" in item for item in report["errors"]), report
PY
