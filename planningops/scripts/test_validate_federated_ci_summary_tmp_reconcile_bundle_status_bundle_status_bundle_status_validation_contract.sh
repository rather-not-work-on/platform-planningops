...
STATUS_PATH="$TMP_DIR/federated-ci-summary-tmp-reconcile-bundle-status-bundle-status-bundle-status.json"
VALIDATION_PATH="$TMP_DIR/federated-ci-summary-tmp-reconcile-bundle-status-bundle-status-bundle-status-validation.json"
SCHEMA_PATH="$ROOT_DIR/schemas/federated-ci-summary-tmp-reconcile-bundle-status-bundle-status-bundle-status-validation.schema.json"

cat >"$STATUS_PATH" <<'JSON'
{
  "generated_at_utc": "2026-03-22T00:10:00+00:00",
  ...
  "artifact_file": "/tmp/status.json",
  "status_path": "/tmp/status.json",
  "status_validation_path": "/tmp/status-validation.json",
  "nested_bundle_path": "/tmp/nested-bundle.json",
  "nested_bundle_validation_report_path": "/tmp/nested-bundle-validation.json",
  "run_id": "bundle-status-bundle-status-bundle-status-validation-sample",
...
cat >"$VALIDATION_PATH" <<'JSON'
{
  ...
  "generated_at_utc": "2026-03-22T00:10:01+00:00",
  "verdict": "pass",
  "error_count": 0,
  "warning_count": 0,
  "errors": [],
  "warnings": [],
  "status_generated_at_utc": "2026-03-22T00:10:00+00:00",
  "status_output_path": "__STATUS_PATH__",
  "status_validation_output_path": "__VALIDATION_PATH__",
  "status_run_id": "bundle-status-bundle-status-bundle-status-validation-sample",
...
if [[ "$rc" -ne 0 ]]; then
  echo "expected broken status-bundle-status-bundle-status validation report to fail schema validation"
  exit 1
fi

echo "validate federated ci summary tmp reconcile bundle status bundle status bundle status validation contract ok"
