...
run_check "loop-guardrails" "policy" \
  bash -lc "cd '${ROOT_DIR}' && python3 planningops/scripts/run_track1_gate_dryrun.py --kpi-path planningops/fixtures/track1-kpi-baseline-ci.json --strict && bash planningops/scripts/test_track1_gate_dryrun_contract.sh && bash planningops/scripts/test_bootstrap_two_track_backlog_contract.sh && bash planningops/scripts/test_compile_plan_to_backlog_contract.sh && bash planningops/scripts/test_verify_plan_projection_contract.sh && python3 planningops/scripts/compile_plan_to_backlog.py --contract-file planningops/fixtures/plan-execution-contract-sample.json --output planningops/artifacts/validation/plan-compile-report.json && python3 planningops/scripts/verify_plan_projection.py --contract-file planningops/fixtures/plan-execution-contract-sample.json --snapshot-file planningops/fixtures/plan-projection-snapshot-sample.json --strict --output planningops/artifacts/validation/plan-projection-report.json && bash planningops/scripts/test_meta_plan_graph_schema_contract.sh && bash planningops/scripts/test_build_meta_plan_graph_contract.sh && bash planningops/scripts/test_meta_plan_orchestrator_contract.sh && python3 planningops/scripts/build_meta_plan_graph.py --contract-file planningops/fixtures/meta-plan-graph-sample.json --strict --output planningops/artifacts/meta-plan/meta-graph.json && python3 planningops/scripts/meta_plan_orchestrator.py --meta-graph-contract planningops/fixtures/meta-plan-graph-sample.json --mode dry-run --strict --meta-graph-output planningops/artifacts/meta-plan/meta-graph.json --output planningops/artifacts/meta-plan/meta-execution-report.json && bash planningops/scripts/test_validate_project_field_schema_matrix.sh && bash planningops/scripts/test_module_readme_contract.sh && bash planningops/scripts/test_validate_repo_boundaries_contract.sh && bash planningops/scripts/test_validate_script_roles_contract.sh && bash planningops/scripts/test_validate_issue_quality_contract.sh && python3 planningops/scripts/validate_issue_quality.py --strict && bash planningops/scripts/test_normalize_ready_implementation_blueprint_refs.sh && bash planningops/scripts/test_issue_loop_runner_multi_repo_intake.sh && bash planningops/scripts/test_ralph_loop_local_worker_policy.sh && bash planningops/scripts/test_validate_worker_task_pack_contract.sh && bash planningops/scripts/test_loop_checkpoint_resume.sh && bash planningops/scripts/test_lease_lock_watchdog.sh && bash planningops/scripts/test_escalation_gate.sh"
