...
python3 "$ROOT_DIR/scripts/validate_federated_ci_summary_tmp_reconcile_bundle_status_bundle_status_bundle_status_bundle_status_bundle.py" --bundle-file "$NEXT_BUNDLE_PATH" --output "$NEXT_BUNDLE_VALIDATION_PATH" --strict >/dev/null

output="$("$ROOT_DIR/scripts/gate_federated_ci_summary_tmp_reconcile_bundle_status_bundle_status_bundle_status_bundle_status_bundle.sh" \
