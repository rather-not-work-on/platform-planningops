...
import validate_monday_agent_harness_projection_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle as bundle_validation
import validate_monday_agent_harness_projection_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status as status_validation
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Print monday agent harness projection resolved "
            "status-bundle-status-bundle-status-bundle-status-bundle-status-bundle-status-bundle health"
        )
    )
...
def load_bundle(args: argparse.Namespace) -> tuple[Path, dict]:
    ...
    bundle_doc = bundle_resolver.resolve_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle(
...
def doctor_errors(bundle_doc: dict, validation_report: dict) -> list[str]:
    ...
    if bundle_doc.get("ready") is not True:
        append_unique(
            errors,
            "resolved status bundle status bundle status bundle status bundle status bundle status bundle ready is false",
        )
    ...
    if bundle_doc.get("next_step") != "none":
        append_unique(
            errors,
            "resolved status bundle status bundle status bundle status bundle status bundle status bundle next_step is not none",
        )
    return errors
    ...
    *,
    ...
    next_step = (
        ...
        if ready
            ...
            bundle_doc.get("next_step")
            or "inspect monday projection status bundle status bundle status bundle status bundle status bundle status bundle"
        )
    )
    return {
        "bundle_path": str(bundle_path.resolve()),
        "resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path": bundle_doc.get(
        ...
        "errors": errors,
        "warnings": warnings,
        "bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_path": bundle_doc.get(
            "bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_path"
        ),
        "bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_validation_path": bundle_doc.get(
...
def render_lines(kind: str, bundle_path: Path, bundle_doc: dict, validation_report: dict) -> list[str]:
    ...
    return [
        ...
        f"bundle status bundle status bundle status bundle status bundle status path: {bundle_doc.get('bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_path') or 'missing'}",
        f"bundle status bundle status bundle status bundle status bundle validation path: {bundle_doc.get('bundle_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_validation_path') or 'missing'}",
