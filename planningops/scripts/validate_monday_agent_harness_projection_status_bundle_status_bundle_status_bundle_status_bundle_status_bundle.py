...
def validate_semantics(
    ...
    *,
    ...
    bundle_status_bundle_status_bundle_status_bundle_status_path = resolve_doc_path(
        doc.get("bundle_status_bundle_status_bundle_status_bundle_status_path"),
        base=bundle_path.parent,
    )
    bundle_status_bundle_status_bundle_status_bundle_validation_path = resolve_doc_path(
        doc.get("bundle_status_bundle_status_bundle_status_bundle_validation_path"),
        base=bundle_path.parent,
    )
    ...
    bundle_status_bundle_status_bundle_status_bundle_report = doc.get(
        "bundle_status_bundle_status_bundle_status_bundle_report"
    )
    if not isinstance(bundle_status_bundle_status_bundle_status_bundle_report, dict):
        append_unique(errors, "bundle_status_bundle_status_bundle_status_bundle_report must be an object")
    bundle_status_bundle_status_bundle_status_bundle_validation_report = doc.get(
        "bundle_status_bundle_status_bundle_status_bundle_validation_report"
    )
    if not isinstance(bundle_status_bundle_status_bundle_status_bundle_validation_report, dict):
        append_unique(
            errors,
            "bundle_status_bundle_status_bundle_status_bundle_validation_report must be an object",
        )

    canonical_bundle: dict[str, Any] | None = None
    if bundle_status_bundle_status_bundle_status_bundle_status_path is not None:
        try:
            canonical_bundle = (
                bundle_resolver.resolve_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle(
                    artifact_file=None,
                    status_file=str(bundle_status_bundle_status_bundle_status_bundle_status_path),
            ...
            append_unique(
                errors,
                "could not resolve canonical status-bundle-status-bundle-status-bundle-status-bundle-status bundle: "
                f"{exc}",
            )

    if isinstance(bundle_status_bundle_status_bundle_status_bundle_report, dict):
        if ready != bundle_status_bundle_status_bundle_status_bundle_report.get("ready"):
            append_unique(errors, "ready must match bundle_status_bundle_status_bundle_status_bundle_report.ready")
        if next_step != bundle_status_bundle_status_bundle_status_bundle_report.get("next_step"):
            append_unique(
                errors,
                "next_step must match bundle_status_bundle_status_bundle_status_bundle_report.next_step",
            )
        if status_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get("verdict"):
            append_unique(
                errors,
                "status_verdict must match bundle_status_bundle_status_bundle_status_bundle_report.verdict",
            )
        if status_validation_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
            "status_validation_verdict"
        ):
            append_unique(
                errors,
                "status_validation_verdict must match bundle_status_bundle_status_bundle_status_bundle_report.status_validation_verdict",
            )
        if bundle_status_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
        ...
        if bundle_status_validation_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
        ...
        if projection_validation_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
            "projection_validation_verdict"
        ):
            append_unique(
                errors,
                "projection_validation_verdict must match bundle_status_bundle_status_bundle_status_bundle_report.projection_validation_verdict",
            )
        if projection_validation_state != bundle_status_bundle_status_bundle_status_bundle_report.get(
            "projection_validation_state"
        ):
            append_unique(
                errors,
                "projection_validation_state must match bundle_status_bundle_status_bundle_status_bundle_report.projection_validation_state",
            )
        if status_sidecar_validation_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
            "status_sidecar_validation_verdict"
        ):
            append_unique(
                errors,
                "status_sidecar_validation_verdict must match bundle_status_bundle_status_bundle_status_bundle_report.status_sidecar_validation_verdict",
            )
        if bundle_validation_verdict != bundle_status_bundle_status_bundle_status_bundle_report.get(
        ...
        if (
            bundle_status_bundle_status_bundle_status_bundle_status_path is not None
            and resolve_doc_path(
                bundle_status_bundle_status_bundle_status_bundle_report.get(
            ...
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_report.bundle_status_bundle_status_bundle_status_bundle_output_path must match bundle_status_bundle_status_bundle_status_bundle_status_path",
            )
        if (
            bundle_status_bundle_status_bundle_status_bundle_validation_path is not None
            and resolve_doc_path(
                bundle_status_bundle_status_bundle_status_bundle_report.get(
            ...
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_report.bundle_status_bundle_status_bundle_status_bundle_validation_output_path must match bundle_status_bundle_status_bundle_status_bundle_validation_path",
            )
        for bundle_field, report_field in (
            ...
            if doc.get(bundle_field) != bundle_status_bundle_status_bundle_status_bundle_report.get(
                report_field
            ):
                append_unique(
                    errors,
                    f"{bundle_field} must match bundle_status_bundle_status_bundle_status_bundle_report.{report_field}",
                )

    if isinstance(bundle_status_bundle_status_bundle_status_bundle_validation_report, dict):
        if (
            bundle_status_bundle_status_bundle_status_bundle_status_path is not None
            and resolve_doc_path(
                bundle_status_bundle_status_bundle_status_bundle_validation_report.get(
                    "bundle_status_bundle_status_bundle_status_bundle_status_path"
                ),
                base=bundle_path.parent,
            )
            ...
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_validation_report.bundle_status_bundle_status_bundle_status_bundle_status_path must match bundle_status_bundle_status_bundle_status_bundle_status_path",
            )
        if (
            bundle_status_bundle_status_bundle_status_bundle_status_path is not None
            and resolve_doc_path(
        ...
        if (
            ...
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_validation_report.bundle_status_bundle_status_bundle_status_bundle_validation_output_path must match bundle_status_bundle_status_bundle_status_bundle_validation_path",
            )
        if (
            bundle_status_bundle_status_bundle_status_bundle_validation_path is not None
            and resolve_doc_path(
                bundle_status_bundle_status_bundle_status_bundle_validation_report.get("output_path"),
                base=bundle_path.parent,
            )
            != bundle_status_bundle_status_bundle_status_bundle_validation_path
        ):
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_validation_report.output_path must match bundle_status_bundle_status_bundle_status_bundle_validation_path",
            )
        for bundle_field, report_field in (
            ("bundle_path", "bundle_path"),
            (
            ...
            if doc.get(bundle_field) != bundle_status_bundle_status_bundle_status_bundle_validation_report.get(
                report_field
            ):
                append_unique(
                    errors,
                    f"{bundle_field} must match bundle_status_bundle_status_bundle_status_bundle_validation_report.{report_field}",
                )
    ...
    if canonical_bundle is not None:
        ...
        if doc != expected_bundle:
            append_unique(
                errors,
                "bundle must match canonical monday harness projection status-bundle-status-bundle-status-bundle-status-bundle-status bundle resolution",
            )

    report: dict[str, Any] | None = None
    if not errors:
        report = {
            "status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path": str(
                bundle_path.resolve()
            ),
            "schema_path": str(bundle_schema_path.resolve()),
            "output_path": str(output_path.resolve()),
            "bundle_status_bundle_status_bundle_status_bundle_status_path": (
                str(bundle_status_bundle_status_bundle_status_bundle_status_path.resolve())
                if bundle_status_bundle_status_bundle_status_bundle_status_path is not None
                else None
            ),
            "bundle_status_bundle_status_bundle_status_bundle_validation_path": (
                str(bundle_status_bundle_status_bundle_status_bundle_validation_path.resolve())
                if bundle_status_bundle_status_bundle_status_bundle_validation_path is not None
                else None
            ),
            "bundle_path": outer_bundle_path,
            "resolved_status_bundle_status_bundle_status_bundle_status_bundle_path": resolved_outer_bundle_path,
            "bundle_validation_output_path": bundle_validation_output_path,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "status-bundle-status-bundle-status-bundle-status-bundle-status bundle."
        )
    )
