...
def validate_semantics(status_path: Path, doc: dict[str, Any]) -> tuple[list[str], list[str]]:
    ...
    resolved_bundle_path = doc.get("resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path")
    bundle_status_output_path = doc.get("bundle_status_bundle_status_bundle_status_bundle_status_bundle_output_path")
    ...
    for key, value in (
        ...
        ("resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path", resolved_bundle_path),
    ...
    if (
        ...
        append_unique(
            errors,
            "resolved_status_bundle_status_bundle_status_bundle_status_bundle_status_bundle_path must match bundle_status_bundle_status_bundle_status_bundle_status_bundle_output_path",
        )
    ...
    if isinstance(validation_doc, dict) and validation_path is not None:
        ...
        if (
            bundle_status_bundle_status_bundle_status_bundle_status_path
            != validation_doc.get("bundle_status_bundle_status_bundle_status_bundle_status_path")
        ):
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_status_path must match bundle-validation report bundle_status_bundle_status_bundle_status_bundle_status_path",
            )
        if (
            bundle_status_bundle_status_bundle_status_bundle_validation_path
            != validation_doc.get("bundle_status_bundle_status_bundle_status_bundle_validation_path")
        ):
            append_unique(
                errors,
                "bundle_status_bundle_status_bundle_status_bundle_validation_path must match bundle-validation report bundle_status_bundle_status_bundle_status_bundle_validation_path",
            )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate plain python compatibility manifest status-bundle-status-bundle-status-bundle-status-bundle-status-bundle status report."
    )
